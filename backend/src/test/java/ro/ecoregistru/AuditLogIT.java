...
class AuditLogIT {
    ...
    private String movementBody(String date, String quantity, UUID partner, String extra) throws Exception {
        ...
        return """
                ...
                extra == null ? "\"operation\": \"RECOVERED\", \"register\": \"ANEXA_1\", \"physicalState\": \"SOLID\", \"storageType\": \"CT\", \"transportMeans\": \"AN\", \"packagingCategory\": \"SECONDARY\", \"wasteDestination\": \"Vr\", \"operationCode\": \"R3\"" : extra,
                partner == null ? "" : ",\n  \"partnerId\": \"" + partner + "\"");
    }
