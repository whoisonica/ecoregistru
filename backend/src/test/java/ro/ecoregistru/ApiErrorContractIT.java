    ...
    private org.springframework.test.web.servlet.request.MockHttpServletRequestBuilder postMovement(
        ...
        String body = """
                {"workPointId":"%s","date":"%s","wasteCodeId":"%s","quantity":%s,"unit":"KG",
                 "operation":"RECOVERED","physicalState": "SOLID", "storageType": "CT", "transportMeans": "AN", "packagingCategory": "SECONDARY", "wasteDestination": "Vr", "operationCode":"R3","register":"ANEXA_1","unloadDate":%s}"""
