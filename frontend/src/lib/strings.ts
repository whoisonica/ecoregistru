...
export const strings = {
  ...
  movements: {
    ...
    // Formularul pe înțeles (17.09.2026): aceleași rubrici, în aceeași ordine, cu titluri care
    // întreabă. Numele din acte rămân pe documentele tipărite; aici e doar ecranul.
    askWaste: "Ce deșeu și când",
    askQuantity: "Cât a fost",
    askOperation: "Ce fel de mișcare e",
    askState: "În ce stare e deșeul",
    askHandling: "Unde stă până pleacă",
    askTransport: "Cum pleacă și unde ajunge",
    askRecipient: "Cine îl preia",
    askDocument: "Documentul și notițele",
    askAttachments: "Poze și scanări",
    askAttachmentsHint: "Bonul de cântar, avizul, Anexa 3 semnată — o poză e de ajuns.",
    askWeighed: "Nu am cântar — cântărește cine preia deșeul",
    ...
    pillNone: "Fără",
    // Bonul din dreapta: ce s-a completat, citit din aceleași valori care se salvează.
    receiptTitle: "Bonul mișcării",
    receiptCode: "Deșeu",
    receiptQuantity: "Cantitate",
    receiptAwaiting: "de cântărit",
    receiptFate: "Pleacă spre",
    receiptPartner: "Către",
    receiptOwnSite: "noi, pe amplasament",
    ...
    sameAsLastApplied:
      "Am pus alegerile de pe {date}: stare, depozitare, transport, destinatar, cod R/D. Cantitatea, data și documentul le scrii tu.",
  ...
  settings: {
    ...
    workPoints: {
      ...
      name: "Denumire",
      address: "Adresă",
      authNumber: "Autorizația de mediu nr.",
      authExpiry: "Expiră pe",
      authHint: "Doar dacă depozitul are autorizația lui; goală, se folosește a firmei. Fără autorizație valabilă nu primește transferuri.",
      formsSeries: "Seria registrului de formulare primite",
    ...
    // D2.3 — cântarele. Temeiul (OG 20/1992 art. 19, art. 24; L.O.-2022) stă în explicații, nu în etichete.
    scales: {
      title: "Cântare",
      subtitle:
        "Cântarele cu care cântărești în depozit. Un cântar e legal cu verificarea metrologică în termen (un an) și declarat la BRML. Primești un mail cu 30 de zile înainte să expire verificarea.",
      add: "Adaugă cântar",
      addTitle: "Adaugă cântar",
      editTitle: "Editează cântarul",
      name: "Nume",
      namePlaceholder: "ex. Podul basculă",
      workPoint: "Depozit",
      serialNumber: "Seria",
      kind: "Tip",
      kindPlaceholder: "ex. Pod basculă 60 t",
      accuracyClass: "Clasa de precizie",
      division: "Diviziunea „e” (kg)",
      plateHint: "De pe plăcuța cântarului.",
      commissionedOn: "Pus în funcțiune pe",
      commissionedHint: "La un cântar nou, primul an de valabilitate curge de aici.",
      brmlDeclaredOn: "Declarat la BRML pe",
      brmlReference: "Nr. înregistrare BRML",
      brmlHint: "Declararea se face înainte de prima cântărire (brml.ro).",
      status: "Stare",
      statusLabels: { IN_USE: "În uz", OUT_OF_USE: "Scos din uz", SEALED: "Sigilat" },
      verification: "Verificare",
      validUntil: "valabil până la",
      history: "Istoric",
      historyTitle: "Istoricul cântarului",
      historyEmpty: "Nicio verificare trecută încă.",
      addEvent: "Adaugă în istoric",
      eventKind: "Ce s-a întâmplat",
      eventKindLabels: { VERIFICATION: "Verificare", REPAIR: "Reparație", INCIDENT: "Incident" },
      eventDate: "Data",
      eventResult: "Rezultat",
      admitted: "ADMIS",
      rejected: "RESPINS",
      bulletinNumber: "Nr. buletin",
      eventValidUntil: "Valabil până la",
      eventValidUntilHint: "Gol = un an de la verificare. Mai lung nu se poate.",
      laboratory: "Laborator",
      verifier: "Verificator",
      eventNotes: "Observații",
      repairHint: "După o reparație sau un incident, cântarul nu mai e legal până la o verificare nouă.",
      deleteEvent: "Șterge rândul",
      eventAdded: "Adăugat în istoric.",
      eventDeleted: "Rândul a fost șters.",
      empty: "Niciun cântar încă.",
      emptyHint: "Cântarele salvate aici se aleg la cântărire.",
      searchPlaceholder: "Caută după nume, serie sau depozit...",
      delete: "Șterge",
      confirmDeleteTitle: "Ștergi cântarul?",
      confirmDelete:
        "Fișa și istoricul lui dispar. Un cântar cu care s-a cântărit nu se poate șterge — trece-l „Scos din uz”.",
      deleted: "Cântarul a fost șters.",
  ...
  // D2.3 — starea unui cântar, pe ecran ca LED + cuvânt.
  scaleState: {
    VALID: "Verificat",
    NO_VERIFICATION: "Fără verificare",
    EXPIRED: "Verificare expirată",
    REJECTED: "Respins la verificare",
    REPAIRED: "Reparat, de reverificat",
    INCIDENT: "Incident, de reverificat",
    NOT_DECLARED: "Nedeclarat la BRML",
    SEALED: "Sigilat",
    OUT_OF_USE: "Scos din uz",
  },
  weighing: {
    title: "Cântar",
    subtitle:
    ...
    tabTransfer: "Transferuri",
    newTransfer: "Transfer nou",
    transferFrom: "Din depozitul",
    transferTo: "În depozitul",
    transferToPlaceholder: "Alege depozitul",
    transferHint: "Marfa rămâne în firmă: fără partener, preț sau cod R/D. Pleacă cu aviz „Fără factură” și Anexa 3.",
    route: "Traseu",
    sentReceived: "Plecat / primit",
    difference: "Diferență",
    statusInTransit: "În tranzit",
    statusReceived: "Recepționat",
    dispatch: "Pleacă",
    confirmDispatchTitle: "Pleacă transferul?",
    confirmDispatch:
      "Liniile ies din depozitul de plecare și marfa e „în tranzit” până o recepționează depozitul de destinație. După plecare nu se mai modifică.",
    dispatched: "Transferul a plecat. Îl recepționează depozitul de destinație.",
    receive: "Recepționează",
    receiveTitle: "Recepția transferului",
    receiveHint:
      "Cântărește marfa cu cântarul depozitului de destinație. Pe Anexa 3 rămâne cantitatea de la plecare; greutatea voastră se notează la Observații.",
    receivedOn: "Ajuns pe",
    receiptSent: "Plecat",
    receiptReceived: "Primit",
    received: "Transferul a fost recepționat.",
    tolerance: "Toleranța cântarelor",
    toleranceUnknown: "necunoscută (cântarele n-au clasa și diviziunea)",
    nirNumber: "Nr. NIR",
    differenceReason: "Decizia comisiei",
    differenceHint:
    ...
    formsTitle: "Trece un formular primit",
    formsCorrectTitle: "Corectează rândul",
    formsHint:
      "Fiecare Anexa 3 (sau Anexa 2) primită cu marfa se trece aici. Registrul nu se șterge și nu se rescrie: o greșeală se corectează cu un rând nou.",
    formsDepot: "Depozitul",
    formsEntry: "Nr.",
    formsReceivedOn: "Primit pe",
    formsForm: "Formular",
    formsKind: "Formularul",
    formsKindAnexa3: "Anexa 3",
    formsKindAnexa2: "Anexa 2 (periculoase)",
    formsSeries: "Seria",
    formsNumber: "Numărul",
    formsDate: "Din data",
    formsSender: "Expeditor",
    formsSenderCui: "CUI expeditor",
    formsWaste: "Deșeul",
    formsQuantity: "Cantitate (kg)",
    formsNotes: "Observații",
    formsCorrects: "Corectează nr.",
    formsCorrectedBy: "Corectat de nr.",
    formsCorrect: "Corectează",
    formsReason: "De ce corectezi",
    formsSaved: "Formularul a fost trecut în registru.",
    formsCorrected: "Corectura a fost trecută în registru.",
    formsEmpty: "Niciun formular trecut în anul ăsta.",
    formsEmptyHint: "Recepția unui transfer trece singură Anexa 3 a depozitului care a trimis.",
    formsPdf: "Registrul (PDF)",
    formsPdfError: "Nu am putut descărca registrul.",
    formsLoadError: "Nu am putut încărca registrul.",
    // F3 — stocul.
    tabStock: "Stoc",
    stockDepot: "Depozitul",
    stockAllDepots: "Toate depozitele",
    stockDate: "La data",
    stockShow: "Afișează",
    stockOnlyNegative: "Doar de corectat",
    stockAll: "Tot stocul",
    stockCode: "Cod",
    stockArticle: "Sortiment",
    stockKg: "Stoc (kg)",
    stockInTransit: "În tranzit",
    stockCommitted: "Angajat",
    stockAvailable: "Disponibil",
    stockNegative: "Negativ",
    stockHint:
      "Calculat din operațiunile finalizate. „În tranzit”: transferuri plecate spre depozit, nerecepționate. „Angajat”: ieșiri și transferuri încă în lucru.",
    stockEmpty: "Nimic în stoc la data asta.",
    stockEmptyHint: "Stocul crește cu intrările finalizate și scade cu ieșirile.",
    stockLoadError: "Nu am putut încărca stocul.",
    stockNegativeCount: "{n} rânduri de corectat: a ieșit mai mult decât s-a înregistrat că a intrat.",
    stockWarning: "Atenție: stocul a ieșit negativ la {items}. Operațiunea s-a salvat; verifică intrările lipsă.",
    // D3.3 și D3.4 — pragurile, vechimea și limitele din autorizație.
    stockAge: "Vechime",
    stockAgeDays: "{n} zile",
    stockAgeFlag: {
      ONE_YEAR: "Peste 1 an",
      THREE_YEARS: "Peste 3 ani",
      LIMIT: "Peste autorizație",
    },
    stockAgeHint:
      "Cel mai vechi lot încă pe amplasament (primul intrat iese primul). Legea: cel mult 1 an înainte de eliminare, 3 ani înainte de valorificare — dacă autorizația nu spune altceva.",
    stockBelowMin: "Sub minim",
    stockAboveMax: "Peste maxim",
    stockLimitsTitle: "Limitele din autorizație",
    stockLimitExceeded: "Depășit",
    stockLimitOk: "În limită",
    stockLimitNotCompared: "fără comparație (aplicația nu măsoară asta)",
    stockLimitKind: { STORED: "Stocat pe amplasament", TREATED: "Tratat", OUTPUT: "Ieșit" },
    stockLimitPeriod: { AT_ONCE: "la un moment dat", MONTH: "pe lună", YEAR: "pe an" },
    stockLimitAllCodes: "toate codurile",
    stockLimitApproximate: "aproximativ",
    stockSettings: "Praguri și limite",
    stockSettingsTitle: "Praguri și limite · {depot}",
    stockSettingsHint:
      "Pragurile sunt ale voastre, pentru alertă. Limitele le copiați din autorizația de mediu a depozitului, cum sunt scrise acolo.",
    stockThresholdsTitle: "Praguri pe sortiment",
    stockMin: "Minim (kg)",
    stockMax: "Maxim (kg)",
    stockSaveThreshold: "Salvează pragul",
    stockAddLimit: "Adaugă limita",
    stockLimitQuantity: "Cantitatea",
    stockLimitUnit: "Unitatea",
    stockLimitCode: "Codul",
    stockLimitDays: "Durata maximă de stocare (zile)",
    stockLimitNote: "De unde (ex. pct. 3 din autorizație)",
    stockSaved: "Salvat.",
    stockPickDepot: "Alege un depozit ca să vezi pragurile, vechimea și limitele lui.",
    newIn: "Intrare nouă",
    newOut: "Ieșire nouă",
    ...
    paymentFromServerHint:
      "Sumele de la ultima salvare, calculate de server din prețurile trecute de administrator. Prețul pe kg îl vede doar el.",
    scale: "Cântarul",
    scaleNone: "Niciun cântar în depozitul ăsta — îl adaugi din Setări → Cântare.",
    scaleAtWeighing: "Starea la cântărire:",
    scaleReason: "Motivul confirmării:",
    scaleReasonTitle: "Cântarul nu era legal la cântărire",
    scaleReasonBody:
      "Un cântar fără verificarea metrologică în termen sau nedeclarat la BRML nu e mijloc de măsurare legal (OG 20/1992 art. 19 și 24). Poți finaliza totuși, dar scrie de ce: motivul rămâne pe operațiune și în jurnal.",
    scaleReasonLabel: "De ce finalizezi totuși",
    scaleReasonPlaceholder: "ex. verificarea e programată pe 30.09; cântărire de control pe cântarul vecin",
    finalizeWithReason: "Finalizează cu motiv",
  ...
  partners: {
    ...
    step1Name: "Despre partener",
    // Bara de pași de pe telefon are o treime de ecran pe pas: numele încap numai scurte.
    stepShort1: "Partenerul",
    stepShort2: "Ce face",
    stepShort3: "Autorizația",
    step1Title: "Detalii despre partener",
    step1Subtitle: "Scrie CUI-ul și apasă „Completează din ANAF”: denumirea, adresa și Registrul Comerțului vin singure.",
    step2Name: "Ce face pentru tine",
    step2Title: "Ce face pentru tine",
    ...
    whyLink: "De ce?",
    // Cardurile tipului: o propoziție care spune ce e fiecare, în locul listei derulante.
    typeQuestion: "Ce face cu deșeul?",
    typeCollectorHint: "Îți ia deșeurile și le duce mai departe, la cine le reciclează sau le elimină.",
    typeRecovererHint: "Le reciclează sau le folosește chiar el, ca materie primă sau combustibil.",
    typeGeneratorHint: "O firmă care produce deșeuri, ca tine. De la ea preiei, nu către ea predai.",
    typeNoneCard: "Doar le transportă",
    typeNoneCardHint: "Mută deșeul de la tine la destinatar, fără să facă nimic cu el.",
    roleQuestion: "Cine pe cine facturează?",
    carrierQuestion: "Cine duce deșeul de la tine la el?",
    carrierYesCard: "Vine el și îl ia",
    carrierYesCardHint:
      "Are mașinile și șoferii lui. La fiecare predare îi alegi din listă, iar mașina și șoferul se scriu singure pe Anexa 3.",
  ...
  clients: {
    ...
    // --- F-B: tabelul ca tablou de lucru (todo-clienti-abonamente.md) ---
    statActive: "Clienți activi",
    statActiveSub: "din {n}",
    statPaid: "Încasat în {month}",
    statPaidOne: "factură plătită",
    statPaidMany: "facturi plătite",
    statDue: "De încasat",
    statDueOne: "factură emisă",
    statDueMany: "facturi emise",
    statAttention: "Cer atenție",
    statAttentionNone: "Nimic de făcut",
    reasonFailedOne: "căzută",
    reasonFailedMany: "căzute",
    reasonOverdueOne: "restant",
    reasonOverdueMany: "restanți",
    reasonNoUsers: "fără utilizatori",
    requestOne: "cerere de cont nouă",
    requestMany: "cereri de cont noi",
    ...
    invoiceOverdue: "Depășită {days}",
    invoiceFailed: "Emitere căzută",
    invoiceDraft: "Neemisă",
    profileComplete: "Completă",
    profileGapOne: "lipsă",
    profileGapMany: "lipsuri",
    profileGapsHint: "Lipsesc din fișă: {fields}. Se tipăresc pe documente; goale, rubrica iese goală.",
    profileCui: "CUI de corectat",
    gapFields: { address: "adresa", caenCode: "codul CAEN", wasteManagerName: "persoana desemnată" },
    unknown: "?",
    open: "Deschide",
    subscriptionAction: "Abonament",
    sortedByAttention: "sortat după „cer atenție”, apoi nume",
  ...
  /** F-A (17.09.2026) — ecranul Facturare al platformei: rulările și facturile tuturor clienților. */
  invoicing: {
    title: "Facturare",
    subtitle: "Facturile tuturor clienților, emise prin FGO. Rularea emite ce e de emis și citește plățile; automat, în fiecare zi la 06:30.",
    run: "Rulează facturarea acum",
    running: "Se rulează…",
    lastRun: "Ultima rulare",
    noRun: "Nicio rulare încă. Prima automată e mâine la 06:30.",
    runLoadError: "Nu am putut încărca ultima rulare.",
    kindManual: "de mână",
    kindScheduled: "automat",
    issuedOne: "factură emisă",
    issuedMany: "facturi emise",
    paidOne: "factură plătită",
    paidMany: "facturi plătite",
    failedOne: "factură căzută",
    failedMany: "facturi căzute",
    notStartedOne: "abonament care nu începe încă",
    notStartedMany: "abonamente care nu încep încă",
    nothingToDo: "Nimic de emis și nicio plată nouă.",
    rowFailed: "Nu s-a emis",
    rowIssued: "Emisă",
    rowPaid: "Plătită",
    rowNotStarted: "Nu începe încă",
    startsOn: "Abonamentul pornește pe {date}",
    openSubscription: "Deschide abonamentul",
    fix: "Corectează",
    fixCui: "Corectează CUI-ul în Clienți",
    stop: "Oprește",
    stopTitle: "Oprești abonamentul lui {client}?",
    stopMessage:
      "Factura refuzată de FGO se șterge; în FGO nu există, fiindcă n-a fost emisă. Fără alte facturi, abonamentul se șterge și clientul nu mai e facturat. Cu facturi emise înainte, abonamentul se oprește în ziua dinaintea acestei perioade.",
    stopped: "Abonamentul lui {client} e oprit.",
    stopError: "Abonamentul nu a putut fi oprit.",
    invoices: "Facturi",
    filters: {
      ACTION: "De rezolvat",
      ALL: "Toate",
      FAILED: "Căzute",
      UNPAID: "Emise, neplătite",
      OVERDUE: "Restante",
      PAID: "Plătite",
    },
    filterLabel: "Arată facturile",
    month: "Luna perioadei",
    allMonths: "Toate lunile",
    searchPlaceholder: "Caută client sau număr (WH 12)…",
    details: "Detalii",
    hideDetails: "Ascunde detaliile",
    nothingToFix: "Nimic de rezolvat din rularea asta.",
    noInvoicesAction: "Nimic de rezolvat: nicio factură căzută sau restantă.",
    number: "Nr.",
    client: "Client",
    period: "Perioada",
    status: "Stare",
    ...
    stateDraft: "Neemisă",
    stateIssued: "Emisă",
    stateOverdue: "Restantă",
    statePaid: "Plătită",
    paidOn: "plătită {date}",
    byCard: "card",
    byTransfer: "transfer",
    checkedAt: "verificat {when}",
    neverChecked: "neverificat încă",
    reminderSent: "memento trimis",
    checkPayment: "Verifică plata",
    checkedPaid: "{number} e plătită.",
    checkedUnpaid: "{number}: FGO nu vede încă plata.",
    checkError: "Plata nu a putut fi verificată.",
    noInvoices: "Nicio factură în lista asta.",
    loadError: "Nu am putut încărca facturile.",
    today: "azi, {time}",
  },
  ...
  subscriptions: {
    ...
    invoiceDue: "scadentă {date}",
    invoicePdf: "PDF",
    toInvoicing: "Rularea și toate facturile: Facturare",
  ...
  enums: {
    ...
    wasteOperation: {
      ...
      TRANSFERRED_OUT: "Transfer trimis la alt depozit",
      TRANSFERRED_IN: "Transfer primit de la alt depozit",
    },
  ...
  // F-C — „Client nou” în pași (todo-clienti-abonamente.md): firma, ce face, abonamentul, administratorul.
  newClient: {
    title: "Client nou",
    ...
    backToClients: "← Clienți",
    stepsLabel: "Pașii clientului nou",
    step1: "Firma",
    step2: "Ce face",
    step3: "Abonamentul",
    step4: "Administratorul",
    back: "Înapoi",
    next: "Continuă",
    nextTo: "Continuă: {step}",
    // Pasul 1
    county: "Județ",
    countyPlaceholder: "Alege județul",
    countyHint: "Din nomenclatorul FGO, pentru factură.",
    countyNotMatched: "ANAF a dat județul „{county}”, care nu e în nomenclatorul FGO. Alege-l din listă.",
    city: "Localitate",
    // Pasul 2
    ...
    typeHint: {
      ...
      BOTH: "Produce deșeuri și preia și de la alții.",
    },
    // Pasul 3
    planLabel: "Pachetul",
    planDescription: {
    ...
    perMonth: "lei / lună",
    plusImplementation: "+ {fee} implementare",
    noImplementation: "fără implementare",
    startedAt: "Începe pe",
    startedAtHint: "Prima factură se emite în ziua asta.",
    founderLabel: "Client fondator",
    founderNo: "Nu",
    ...
    sameAddress: "Adresa firmei, de la pasul 1",
    ...
    checksFailed: "Completează ce e bifat cu roșu sau salvează fără abonament.",
    withoutSubscription: "Salvează fără abonament",
    withoutSubscriptionOn: "Fără abonament: clientul nu se facturează. Îl poți pune oricând din lista de clienți.",
    withSubscriptionAgain: "Pune abonamentul",
    // Pasul 4
    adminHint: "Primește pe email un link cu care își alege parola. Linkul ține 7 zile.",
    adminNow: "Trimite invitația acum",
    adminLater: "Mai târziu",
    adminLaterHint: "Clientul rămâne fără utilizatori și apare la „Cer atenție” până inviți pe cineva.",
    adminEmail: "Email",
    adminFirstName: "Prenume",
    adminLastName: "Nume",
    emailInvalid: "Emailul nu arată bine.",
    create: "Creează clientul",
    creating: "Se creează…",
    createError: "Clientul nu a fost creat. Nimic nu s-a salvat.",
    // Rezumatul
    doneTitle: "{name} e gata",
    doneSubscription: "Abonament {plan}, prima factură {total}, emisă pe {date}.",
  ...
  accountRequest: {
    ...
    errCuiFormat: "CUI-ul nu e valid: verifică cifrele, ultima e cifra de control. Se scrie cu sau fără „RO” în față.",
