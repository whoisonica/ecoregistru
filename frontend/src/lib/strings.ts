...
export const strings = {
  ...
  partners: {
    ...
    step2Subtitle: "Ce face cu deșeul, cine pe cine facturează și dacă vine el să-l ia.",
    ...
    carrierQuestion: "Vine el să ia deșeul?",
    carrierSwitch: "Transportator — face și transportul",
