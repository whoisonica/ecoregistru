...
await page.fill("#ar-wp-address", "Str. Probelor nr. 12");
await page.fill("#ar-auth-number", "AM-PROBA-12");
await page.fill("#ar-auth-expiry", "2028-06-30");
await page.click('button:has-text("Continuă")');
await page.waitForTimeout(300);
await page.fill("#ar-contact-name", "Proba Legală");
await page.fill("#ar-contact-phone", "0740000012");
