...
const created = await page.evaluate(async () => {
  ...
  const body = (quantity) => JSON.stringify({
    ...
    physicalState: "SOLID", operation: "RECOVERED", register: "ANEXA_1", operationCode: "R13", storageType: "CT", transportMeans: "AN", physicalState: "SOLID", wasteDestination: "Vr", notes: "proba 22 — istoric",
  });
