...
ascunse din „De făcut” — cu „Nebifat” gri, fără „Depășit” și fără zile; 375px carduri, fără derulare. O firmă nouă cu AFM lunar
n-are termene trecute salvate: „Trecute” le arată „Calculat” (din profil, fără id, fără buton) și după deschidere tot nu e nimic
salvat. **Negative:** badge-ul obișnuit pe „Trecute” → 1 cădere; butonul pe rândurile calculate → 1 cădere. Lasă în urmă
„Proba 35 <număr>”.
...
| Suita | Ce probează |
|---|---|
| `1-ecrane.mjs` | Ecranele firmei se deschid — Acasă, Generare, Intrări, Ieşiri, Parteneri, Termene, Dosar de control, Setări cu o secţiune a ei, plus adresele vechi care redirecţionează (`/miscari`, `/intrari-iesiri`, `/evidente`, `/ambalaje`) — apoi Clienţi ca platformă şi paginile publice (login, cerere de cont, parolă uitată); fiecare are titlu şi tabel (sau elementul ei), fără erori de consolă, excepţii sau răspunsuri HTTP ≥ 400. Trei roluri: admin, administrator de platformă, public. |
...
> ⚠️ **Cifrele de mai jos sunt ale zilelor în care s-au scris (07–09.09.2026).** De la `V58` (16.09.2026) seed-ul nu mai are
> rânduri de generare, deci firma demo are **29 de mișcări** (`ApplicationBootIT` cere `hasSize(29)`), **6 parteneri** și, alături,
> a doua firmă — generatorul pur „Proba Automata SRL”. Dala „Coduri cu stoc”, pomenită mai jos, a ieșit de pe Acasă tot atunci;
> proba 9 cere acum **absența** ei. Cele patru stări „lipsă” există în continuare și se numără pe nume.
