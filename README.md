...
Evidențe screen, not in the dossier. Each attachment download has a deadline on the whole body, so a stalled file is
...
| The year's totals for the filing | **Evidențe** → "Anexa 1 — lunar", below the table | The year's totals per waste code in **kg**, the unit the specialist confirmed the filing is typed in (the screen showed tonnes until 17.09.2026, and "1,060 t" read as a thousand tonnes). Nothing printed changes |
