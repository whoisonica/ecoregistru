...
| The year's totals per waste code | **Generare** → *Totalul anului* | One row per waste code: generated, recovered, disposed, what is left in stock, and whether it can be filed ("Gata" · "N de cântărit" · "N kg fără cod R/D"). These are the figures typed into SIM on 15 March; the monthly breakdown stays on the printed sheet |
