...
| Control dossier | **Dosar de control** → download | The ZIP opens with `anexa1-«year».pdf` — the same four-chapter sheet — then `evidenta-centralizata-«year».pdf`, plus `anexa1-ambalaje-«year».xls/.pdf` for a producer or importer, and its `README.txt` names the 15 March deadline |
