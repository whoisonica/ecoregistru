# Stadiu — EcoRegistru, arhiva 15–16.09.2026

Partea din [`../status.md`](../status.md) scrisă între 15.09.2026, 01:03 și 16.09.2026, 23:57, mutată aici pe 19.09.2026, ca la
[`status-pana-la-14.09.2026.md`](status-pana-la-14.09.2026.md). Nimic n-a fost rescris. E un jurnal: fiecare intrare spune ce era
adevărat în ziua ei; starea de azi e intrarea cea mai de sus din `../status.md`.
...
> ✅ **Fixul probat pe producție 15.09 ~15:10:** `<adresa proprietarului>+whoperator` (`c8e94cce…`, `enabled = f`, `deactivated_at` 12:01:03 UTC, confirmat în bază) → `request-reset-password` 200 și **niciun** `Sent 'mail/forgot_password'`; controlul pozitiv, consultantul activ, a primit mailul la 15:08 și a intrat (reset 200, login 200). În bază, niciun rând `enabled` + `deactivated_at`.
...
>
> **15.09.2026, ~15:00 — 🔴 → ✅ (reparat și pe producție la 15:00, intrarea de mai sus) un cont dezactivat se putea reactiva singur prin „Parolă uitată” (găsit la citirea codului,
...
> **15.09.2026, seara — 🔄 → ✅ (pe producție la 15:00, app v68, intrarea „fixul contului dezactivat, juridicul v2”) termenii și politica, v2, în cod (la scriere: necommis, nedeployat):** textele din
