# Stadiu — EcoRegistru, arhiva până la 14.09.2026 inclusiv

Partea veche din [`../status.md`](../status.md), mutată aici pe 16.09.2026 ca jurnalul viu să se poată citi. Nimic
n-a fost rescris: blocurile citate de mai jos sunt cele din capul vechiului `status.md` (10–14.09.2026), iar secțiunile
`##` sunt feliile livrate între 22.08 și 12.09.2026 (G-1…G-10, P0, 11-bis, P1.10–P1.12, P3.1, auditul QA). Trimiterile
de forma „`status.md` G-3” din `legislatie.md` și `surse-oficiale.md` duc aici.
...
două note. Analiza pe exemplar, cu ce e privat în ea, rămâne în `anexa2-model-completat.md` (șters la curățenia din 15.09.2026; în git, `ecoregistru-docs` `05609b2`).
