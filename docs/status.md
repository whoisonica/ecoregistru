...
> **20.09.2026, ziua — ✅ securitate, R1–R3 și plasele de siguranță** (necommis și nedeployat la scrierea intrării; migrare nouă **`V64`**, liberă **`V65`**). Măsurat pe rulare curată: backend **1069 de teste / 134 de clase, 0 căzute, 4 sărite**; acoperire jacoco **93,9% linii / 79,2% ramuri / 99% clase**; `npm test` **67/67**; ESLint **0 erori, 29 avertismente**; `tsc` și `npm run build` curate, bundle **997 kB**; **e2e 43/43** pe stivă proprie (bază nouă `eco_e2e_r43`, backend pe 8081 — pe 8080 rula altceva, neatins).
>
