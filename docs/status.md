...
> **18.09.2026, ~10:30 — 🟡 pe `main`, nedeployat: documentele urcă deasupra tabelului, iar coloana „În stoc" iese de pe Generare** (numai frontend; backendul, migrările și generatoarele de documente neatinse, schema **V63**, liberă **V64**).
