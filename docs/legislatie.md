...
- ✅ **Art. 49 alin. (9) — al doilea termen anual, 30 aprilie**, pentru titularii de autorizații de construire/desființare **și pentru producătorii și deținătorii de uleiuri uzate**. Sancțiune: art. 62 alin. (1) lit. e), **5.000–10.000 lei**. **Construit pe 11.09.2026** (`APM_ANNUAL_APRIL`, `V36`): jumătatea de uleiuri se derivă din mișcări, jumătatea de construcții se întreabă în profil. `surse-oficiale.md` §2.5 · felia `status.md` G-3.
...
- 🆕 **Art. 44 alin. (3) — al patrulea termen anual, 31 mai** (găsit 11.09.2026): programul de prevenire și reducere a cantităților de deșeuri **se publică pe site-ul propriu** al firmei **și** se transmite anual agenției județene, cu progresul, până la 31 mai a anului următor. Obligația e a persoanei juridice **pentru care s-a emis o autorizație de mediu** — deci semnalul e `Company.environmentalAuthNumber`, rubrică existentă. Sancțiune: art. 62 alin. (1) lit. a), **40.000–60.000 lei** — de șase ori cât 30 aprilie. **Construit în aceeași zi** (`APM_ANNUAL_MAY`, fără migrare). `surse-oficiale.md` §2.9 · `status.md` G-10.
...
| **Depozit — operaţiunea de cântar** ca document justificativ (Legea 82/1991): În lucru → Finalizată → nemodificabilă; anularea cere motiv | `WeighingOperation` + `WeighingOperationService` (`V46`), `/api/v1/weighing-operations` | ✅ *(15.09.2026, fără ecran încă)* |
...
| Codul fiscal art. 115 (10% la metale PF), OUG 196/2005 (2% AFM), borderoul OUG 31/2011 | temeiurile citite în `surse-oficiale.md` §18; calculele şi borderoul vin în feliile următoare | 🔜 |
