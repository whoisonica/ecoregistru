...
- 🔴 **Art. 49 alin. (9) — al doilea termen anual, 30 aprilie**, pentru titularii de autorizații de construire/desființare **și pentru producătorii și deținătorii de uleiuri uzate**. Sancțiune: art. 62 alin. (1) lit. e), **5.000–10.000 lei**. **Nu e în calendarul aplicației** — vezi §3, rândul `ReportingDeadline`. `surse-oficiale.md` §2.5 · felia `todo-lansare.md` P3.7.
...
| `ReportingDeadline` | ✅ termenul anual **15 martie** (art. 48(1)) numit după document, contribuțiile AFM pe ritmul fiecăreia — lunar / trimestrial / anual (`V21`) — și, din 04.09.2026, **25 februarie** pentru raportarea de ambalaje (`PACKAGING_ANNUAL`, Ordin 794/2012 art. 6), generat doar la un profil **răspuns** care pune ambalaje pe piață. Termenul de 25 ianuarie numește de-acum ambele obligații care cad atunci la AFM | 🔴 **lipsește 30 aprilie** — art. 49 alin. (9): titularii de autorizații de construire/desființare **și producătorii/deținătorii de uleiuri uzate** raportează anual la APM conformarea cu art. 17(7) și măsurile de la art. 31(1). Sancțiune 5.000–10.000 lei. Semnalul e derivabil din date (mișcări pe coduri de ulei uzat — `13 02 08*` e chiar codul din seed), deci nu cere întrebare, cere `ReportType` nou. `surse-oficiale.md` §2.5 · `todo-lansare.md` **P3.7** | 🔴 **mare** |
...
| — | Al doilea termen anual | **30 aprilie** — construcții/desființări și **uleiuri uzate**, la APM *(găsit 10.09.2026)* | OUG 92/2021 art. 49(9) · `surse-oficiale.md` §2.5 |
