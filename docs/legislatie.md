...
| — | ✅ **totalul anual per cod stă pe ecranul Evidențe, în kg** (din 17.09.2026; între 04.09 și 17.09 era în tone). Andreea (AF, 14.09.2026): evidența se depune în **kg**, iar „1,060 t” se citea ca o mie de tone. Formatarea e într-un singur loc (`frontend/src/lib/units.ts`). Fișa de gestiune și declarația de ambalaje sunt în kg pe hârtie; un „document de depunere” nou ar fi fost un format oficial inventat | ✅ exportul în tone al registrului art. 48 există din 15.09.2026: totalurile SIM în tone, tabelul cronologic în kg și t | ✅ |
