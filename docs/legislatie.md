...
- 🆕 **Art. 34¹, în vigoare 11.07.2026** (Legea 26/2026): ANMAP publică online **lista tuturor operatorilor autorizați** — denumire, **CUI**, activități autorizate, documentul integral al autorizației și **statusul vizei anuale** —, actualizată în 10 zile lucrătoare. E sursa publică pe care n-o aveam la verificarea destinatarului (întrebarea **AH**), și aduce un câmp pe care modelul nu-l are deloc: **viza anuală**. `surse-oficiale.md` §2.6 · felia `todo-lansare.md` P3.9.
...
| Registrul art. 48 OUG 92/2021 | `Art48RegisterBuilder` + `Art48RegisterGenerator` peste mișcările `ART_48` (xlsx + PDF, ecranul „Intrări și ieșiri”); `Reception` / `Delivery` rămân schemă | ✅ export 15.09.2026 · 🔜 recepțiile, Etapa 8 |
