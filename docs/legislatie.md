...
| — | ✅ **conversia kg → tone există din 04.09.2026**, într-un singur loc (`frontend/src/lib/units.ts`), și se vede pe ecranul Evidențe ca total anual per cod. Fișa de gestiune și declarația de ambalaje **rămân în kg pe hârtie** — acolo sunt corecte, iar un „document de depunere” nou ar fi fost un format oficial inventat | ✅ exportul în tone al registrului art. 48 există din 15.09.2026: totalurile SIM în tone, tabelul cronologic în kg și t | ✅ |
